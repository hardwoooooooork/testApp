...
export default class KakaoMap extends Component {
     ...
     */
    setKakaoMap = ()=>{
        // const API_KEY = "6b1ecc39e82e178687758a58874a66cf"
        ...
        $script(kakao_url, () => {
            ...
            kakao.maps.load(function () {
                ...
                // 커스텀 오버레이에 표시할 내용입니다     
                // HTML 문자열 또는 Dom Element 입니다 
                // var content = '<div class ="label" style="background-color: #fff;"><span class="left"></span><span class="center">카카오!</span><span class="right"></span></div>';

                // 커스텀 오버레이가 표시될 위치입니다 
                // var position = new that.kakao.maps.LatLng(33.450701, 126.570667);

                // 커스텀 오버레이를 생성합니다
                // var customOverlay = new that.kakao.maps.CustomOverlay({
                //     position: position,
                //     content: content
                // });

                // 커스텀 오버레이를 지도에 표시합니다
                // customOverlay.setMap(that.map);
            });
        });
    }
